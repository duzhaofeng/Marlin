...
uint8_t qspi_init(void)
{
    ...
    g_qspi_handle.Init.ClockPrescaler = 1;                             /* QPSI分频比，BY25Q128最大频率为108M，
    ...
    g_qspi_handle.Init.ChipSelectHighTime = QSPI_CS_HIGH_TIME_5_CYCLE; /* 片选高电平时间为3个时钟(9.1*3=27.3ns),即手册里面的tSHSL参数 */
